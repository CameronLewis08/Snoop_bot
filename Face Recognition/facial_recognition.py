...
def draw_results(frame):
    # Display the results
    data = zip(face_locations, face_names)
    # print(tuple(data))
    center = []
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        cv2.circle(frame, center=(center_x, center_y), radius=2, color=(3, 244, 42))
...
while True:
    ...
    data = zip(face_centroids, face_names)
    print(tuple(data))
    print(final_centroid)
    print(type(final_centroid))
